...
<section class="content-header">
    <h1>
      <i class="fa fa-edit" style="color:green"> </i>  Update Profil - <?= $user->nama;?>
    </h1>
    <ol class="breadcrumb">
			<li><a href="<?php echo base_url('dashboard');?>"><i class="fa fa-dashboard"></i>&nbsp; Dashboard</a></li>
			<li class="active"><i class="fa fa-edit"></i>&nbsp; Update Pengguna - <?= $user->nama;?></li>
    </ol>
</section>
                    ...
                    <form action="<?php echo base_url('user/upd');?>" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="form-group">
                                    <label>NIM</label>
                                    <input type="number" class="form-control" value="<?= $user->nim;?>" name="nim" placeholder="NIM Pengguna" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Nama</label>
                                    <input type="text" class="form-control" value="<?= $user->nama;?>" name="nama" required="required" placeholder="Nama Pengguna" readonly>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
									...
									<?php if($this->session->userdata('level') == 'Admin'){?>
										...
										<option <?php if($user->level == 'Mahasiswa'){ echo 'selected';}?>>Mahasiswa</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="prodi" class="form-control">
                                        <option <?php if($user->prodi == 'Matematika'){ echo 'selected';}?>>Matematika</option>
										<option <?php if($user->prodi == 'Sistem Informasi'){ echo 'selected';}?>>Sistem Informasi</option>
                                        <option <?php if($user->prodi == 'Teknik Elektro'){ echo 'selected';}?>>Teknik Elektro</option>
										<option <?php if($user->prodi == 'Teknik Industri'){ echo 'selected';}?>>Teknik Industri</option>
                                        <option <?php if($user->prodi == 'Teknik Informatika'){ echo 'selected';}?>>Teknik Informatika</option>
                                    </select>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <br/>
                                    <img src="<?= base_url('assets_style/image/'.$user->foto);?>" class="img-responsive" alt="#" style="height:auto;width:35%;">
                                </div>
                                <br>    
                                <div class="form-group">
                                    <label>Alamat</label>
                                    <textarea class="form-control" name="alamat"  required="required"><?= $user->alamat;?></textarea>
                                    <input type="hidden" class="form-control" value="<?= $user->nim;?>" name="nim">
